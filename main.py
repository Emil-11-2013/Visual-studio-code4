...
class RPSGame():
    def __init__(self):
        ...
        pygame.display.set_caption("Rock Paper Scissors Mania")
        ...
        self.choose_paper =
        pygame.image.load("paper.png").convert_alpha()
        self.choose_scissors =
        pygame.image.load("sicissors.png").convert_alpha()
        self.choose_scissors =
        ...
        self.pl_score = 0 self.pc_score = 0
    def player(self):
